...
new Article({author: 'sep1', img: null, date: new Date().getTime(), text: 'This is my first article'}).save()
new Article({author: 'sep1', img: null, date: new Date().getTime(), text: 'This is my second article'}).save()
new Article({author: 'jmg3', img: null, date: new Date().getTime(), text: "This is Max's article"}).save(function() {
